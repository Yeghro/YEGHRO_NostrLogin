...
declare class NDKRelay extends EventEmitter {
    ...
    auth(event: NDKEvent): Promise<string>;
    /**
...
declare class NDK extends EventEmitter {
     ...
     * @returns
     */
    fetchEventFromTag: (tag: NDKTag, subOpts?: NDKSubscriptionOptions | undefined, fallback?: NDKFetchFallbackOptions | undefined) => Promise<NDKEvent | null>;
    /**
...
declare class NDKEvent extends EventEmitter {
     ...
     */
    encode: () => string;
    encrypt: (recipient?: any, signer?: any) => Promise<void>;
    decrypt: (sender?: any, signer?: any) => Promise<void>;
    /**
     ...
     */
    fetchRootEvent: () => Promise<NDKEvent | null | undefined>;
    /**
 ...
 */
declare function getRootEventId(event: NDKEvent, searchTags?: string[]): NDKEventId | null | undefined;
/**
 ...
 */
declare function getRootTag(event: NDKEvent, searchTags?: string[]): NDKTag | undefined;
...
declare class NDKNip46Backend {
     ...
     * @param permitCallback Callback executed when permission is requested
     */
    constructor(ndk: NDK, privateKey: Uint8Array | string, permitCallback: Nip46PermitCallback);
    /**
