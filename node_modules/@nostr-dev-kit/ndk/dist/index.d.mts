...
declare class NDKRelay extends EventEmitter<{
    ...
    addSkippedEvent(): void;
    getValidationRatio(): number;
...
declare class NDKEvent extends EventEmitter {
     ...
     * ```
     */
    tag(event: NDKEvent, marker?: string, skipAuthorTag?: boolean, forceTag?: string): void;
    /**
     ...
     */
    fetchReplyEvent: () => Promise<NDKEvent | null | undefined>;
    /**
 ...
 */
declare function calculateGroupableId(filters: NDKFilter[], closeOnEose: boolean): NDKFilterGroupingId | null;
/**
